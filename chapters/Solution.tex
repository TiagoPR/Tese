...
\begin{lstlisting}[language=HTML, caption={Integração do KlaroJS com a configuração local}, label={lst:klaro-integration}]
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">

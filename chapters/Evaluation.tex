...
De seguida, são apresentados exemplos reais dos registos trocados entre cliente e servidor, representando diferentes decisões de consentimento.  
...
\begin{lstlisting}[ caption={Exemplo de \textit{JWS} gerado para recusar todos os consentimentos.}, label={lst:jws_recusar}]
{
    "payload":"eyJjb...",
    "signatures":[
        {
...
De forma análoga, a Listagem~\ref{lst:payload_aceitar} apresenta o \textit{payload} correspondente à aceitação de todos os consentimentos, e a Listagem~\ref{lst:jws_aceitar} mostra o \textit{JWS} resultante com ambas as assinaturas.
...
\begin{lstlisting}[caption={Exemplo de \textit{JWS} gerado para aceitação de todos os consentimentos.}, label={lst:jws_aceitar}]
{
    "payload":"eyJjb...",
    "signatures":[
        {
